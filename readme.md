...
> A local, air-gapped AI assistant that detects performance bottlenecks in C# code and suggests production-ready .NET 8+ optimizations — deterministically, without hallucination.
...
| 5 | **Deep .NET 8+ specialization** | Purpose-built for modern C# performance patterns, not a general-purpose assistant. |
...
| .NET 8 API accuracy | ⚠️ Hit or miss | ✅ Expert-audited templates |
...
├── roslyn-service/     # .NET 8 C# sidecar (AST extractor + code injector)
